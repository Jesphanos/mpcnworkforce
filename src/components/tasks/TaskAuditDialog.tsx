...
export function TaskAuditDialog({ taskId, open, onOpenChange }: TaskAuditDialogProps) {
  const { data: logs, isLoading } = useEntityAuditLogs("task", taskId || "");
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Complete audit trail of all changes made to this task
          </DialogDescription>
        </DialogHeader>
